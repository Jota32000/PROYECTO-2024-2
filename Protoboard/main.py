...
class Resistencia:
    ...
    def dibujar_resistencia(self):
        color = (251, 179, 92)
        for resistencia in resistencias:  # cables = Resistencia
            pygame.draw.line(screen, "dark gray", (resistencia[0].x, resistencia[0].y), (resistencia[1].x, resistencia[1].y), 3)
            ...
            # Dibujo concreto de resistencia de forma vertical
                ...
                for i in range(5):
                    pygame.draw.line(screen, color, (x_medio - 10 + i, y_medio - 15 + i), (x_medio - 10 + i, y_medio - 15 +2* i), 3)
                    pygame.draw.line(screen, color, (x_medio - 10 + i, y_medio + 15 - i), (x_medio - 10 + i, y_medio + 15 -2* i), 3)
                    pygame.draw.line(screen, color, (x_medio + 10 - i, y_medio + 15 - i), (x_medio + 10 - i, y_medio + 15 -2* i), 3)
                    pygame.draw.line(screen, color, (x_medio + 10 - i, y_medio - 15 + i), (x_medio + 10 - i, y_medio - 15 +2* i), 3)
                ...
                for i in range(5):
                    pygame.draw.line(screen, color, (x_medio - 15 + i, y_medio - 10 + i), (x_medio - 15 + 2*i, y_medio - 10 + i), 3)
                    pygame.draw.line(screen, color, (x_medio + 15 - i, y_medio - 10 + i), (x_medio + 15 - 2*i, y_medio - 10 + i), 3)
                    pygame.draw.line(screen, color, (x_medio + 15 - i, y_medio + 10 - i), (x_medio + 15 - 2*i, y_medio + 10 - i), 3)
                    pygame.draw.line(screen, color, (x_medio - 15 + i, y_medio + 10 - i), (x_medio - 15 + 2*i, y_medio + 10 - i), 3)
    ...
    def finalizar_resistencia(self, conector_siguiente):
        ...
        if "pila" in self.inicio_resistencia.nombre and conector_siguiente.nombre.startswith(("conector3_", "conector4_")):
            print("-------------------------------------------")
        ...
        if (self.inicio_resistencia.x - conector_siguiente.x == 60 or conector_siguiente.x - self.inicio_resistencia.x == 60) or (self.inicio_resistencia.y - conector_siguiente.y == 60 or conector_siguiente.y - self.inicio_resistencia.y == 60):              
        ...
        elif self.inicio_resistencia.nombre.startswith(("conector1_", "conector2_")) and conector_siguiente.nombre.startswith(("pila")):
            for nodo in conectores:
        ...
        self.dibujando_resistencia = False
        self.inicio_resistencia = None
    def dibujar_resistencia_actual(self):
...
while running:
    ...
    resistencia.dibujar_resistencia()
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1 and boton_basurero:
                ...
                if verificador == False:
                    ...
                    basurero.eliminar_resistencia(mouse_x, mouse_y)
                verificador = False
                boton_basurero = False
        ...
        # Manejo de eventos normal para cables, led y switch
            ...
            elif conector_cercano and boton_cable:
                for conector in conectores:
            ...
            elif conector_cercano and boton_cable == False and boton_edicion == False and boton_basurero == False:
                for conector in conectores:
                    if conector_cercano == conector:
                        if not resistencia.dibujando_resistencia:
                            resistencia.comienzo_resistencia(conector)
                        else:
                            resistencia.finalizar_resistencia(conector)
                            ultimo_conector = conector_cercano
    ...
    resistencia.dibujar_resistencia_actual()
