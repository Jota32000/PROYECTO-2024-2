...
class Conector:
    ...
    def dibujar(self,screen,conectores):
    ...
    def agregar_conexion(self, nodo):
        ...
        self.actualizarbosque(self, nodo, conectores)
    ...
    def activar_explosion(self,conector_siguiente,screen,conectores):
    ...
    def actualizarbosque(self, origen, destino,conectores):
        if origen.padre != destino.padre:
            ...
            self.actualizar_padre_subarbol(viejo_padre, nuevo_padre,conectores)
